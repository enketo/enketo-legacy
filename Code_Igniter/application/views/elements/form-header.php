<div class="form-header clearfix">
	...
	<div class='offline-enabled'>
		<? if(!empty($manifest)): ?><div class='offline-enabled-icon not-enabled' title="This form is able to launch offline"></div><? endif; ?><div class='queue-length hide' title="Records Queued - Click to Backup to File"></div>
	</div>

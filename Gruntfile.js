...
js = {
    ...
    files: [
      'file-manager/src/files.js' ].prefix('public/libraries/'),
    engine: [
      'utils.js', 
      'form.js', 
      'widgets.js'].prefix('public/libraries/enketo-core/src/js/'),
    offline: [
      'cache.js'].prefix('src/js/'),
    online: [
      'storage.js',
      'survey_controls.js',
      'connection.js'].prefix('src/js/'),
  };
...
module.exports = function(grunt) {
  grunt.initConfig({
    ...
    jshint: {
      ...
      all: ['Gruntfile.js']// , 'src/**/*.js', '!src/extern.js']
    },
    uglify: {
      options: {

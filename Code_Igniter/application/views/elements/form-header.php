<div class="form-header clearfix">
	...
	<div class='offline-enabled'>
		<? if(!empty($manifest)): ?><div class='offline-enabled-icon not-enabled' title="This form is able to launch offline"></div><? endif; ?><div class='queue-length' title="Records Queued"></div>
	</div>

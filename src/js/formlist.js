...
/*global gui, Form, StorageLocal, Connection, Cache, settings Modernizr, getGetVariable, vkbeautify*/
...
Cache.prototype.informUpdate = function() {
  return gui.confirm( {
    msg: '<div class="alert alert-success">A new version of this application has been downloaded.</div>' + '<br/> Refresh the window to start using it.',
    heading: 'Updated!'
  }, {
    posButton: 'Refresh',
    negButton: 'Cancel',
